  ...
  return (
    <div>
      <Image
        ...
        alt="img"
        height={30}
        className="pl-[20px] pt-[20px] lg:pl-[40px] lg:h-[60px] lg:w-[200px]"
      />
      <div className="flex flex-wrap lg:mt-[80px] mt-[30px] justify-center">
        <span className="lg:w-[600px] p-[30px]">
          <h2 className=" font-[800] text-[28px] lg:text-[40px] pt-[30px]">
            No more disappointment the next time he/she asks{" "}
            <span className="text-[#734000] bg-[#ffd8a7] rounded-[10px] p-[6px]">
              #WhatNext
            </span>{" "}
          </h2>
